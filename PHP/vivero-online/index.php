...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" id="main">
      <!-- Muestra todos los articulos que disponemos -->
      <div class="row">
        <?php
        require 'vendor/autoload.php';
        $articulos = new frikiplantas\Articulos;
        $info_articulos = $articulos->mostrar();
        ...
        <div class="col-md-3">
          ...
          <div class="panel-heading">
            <h4 class="text-center titulo-articulo"><?php print $item['titulo'] ?></h4>
          </div>
            ...
            <div class="panel-footer">
              <a href="carrito.php?id=<?php print $item['id'] ?>" class="btn btn-success btn-block">
                <span class="glyphicon glyphicon-shopping-cart">Comprar</sapn>
              </a>
            </div>
          </div>
        </div>
