    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="../dashboard.php">Frikiplantas</a>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="pull-right">
            <a href="form_registrar.php" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span>Nuevo</a>
          </div>
        </div>
    </div>
    <div class="container" id="main">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                <?php
                  ...
                  $info_articulo = $articulos -> mostrar();
